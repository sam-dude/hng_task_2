          ...
          <div className='grid md:grid-cols-5 sm:grid-cols-3 grid-cols-1 gap-8'>

            {
              movies.slice(0, 10).map((movie, i) => (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 absolute top-4 right-4 text-gray-200 bg-gray-50 z-10 bg-opacity-50 p-2 rounded-full">
